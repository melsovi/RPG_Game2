...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Thor thor = new Thor(210, 15, SuperAbility.DEAFEN, "Thor");
        Golem golem = new Golem(250, 3, SuperAbility.DAMAGE_ABSORPTION, "Golem");
        Witcher witcher = new Witcher(200, 0, SuperAbility.CHANCE_TO_REVIVE, "Witcher");

        Hero[] heroes = {warrior, doc, magic, berserk, assistant, thor, golem, witcher};
        Boss boss = new Boss(1100, 90);
